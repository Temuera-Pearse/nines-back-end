...
import { EVENT_CATALOG, validateCatalogSymmetry, } from './race/events/catalog.js';
...
if (process.env.EDGE_SUBSCRIBER === '1') {
    startEdgeSubscriber().catch((e) => console.warn(`Edge subscriber failed to start: ${String(e)}`));
}
